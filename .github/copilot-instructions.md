...
- Comandos (REGLAS.md, sección 6; también disponibles como prompts en `.github/prompts/`): **GUARDA_y_SUBE**, **SINCRONIZA**, **SINCRONIZA_desde_MD**, **SINCRONIZA_desde_TEX**, **REPASA_BORRADOR**. Cuando el usuario escriba uno de esos nombres, ejecuta el procedimiento de REGLAS.md.
