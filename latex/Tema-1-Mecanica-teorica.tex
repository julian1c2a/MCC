...
Los coeficientes \(A_{mnp}\) se calculan expandiendo el desplazamiento
inicial \(\Psi(x,y,z,0)\) en una serie triple de Fourier. Del mismo
modo, los coeficientes \(B_{mnp}\) se fijan a partir de la velocidad
inicial \(\dfrac{\partial \Psi}{\partial t}(x,y,z,0)\). La ortogonalidad
de los modos permite determinar cada coeficiente por separado mediante
integrales sobre el volumen de la cavidad.
...
espacio-tiempo a partir del campo y de sus derivadas:
